...
<?php
// following.php - Users that this user follows
session_start();
...
$total = db_count("SELECT COUNT(*) FROM user_follows WHERE follower_id = ?", [$profile_user['id']]);
$total_pages = ceil($total / $per_page);

$page_title = 'Following - @' . $username;
...
<div class="page-wrap">
    <div style="margin-bottom:24px;">
        ...
        <p style="font-size:0.82rem;color:var(--text-d);">Following <?= number_format($total) ?> users</p>
    </div>
